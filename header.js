class Header {
  ...
  render(count) {
    ...
    <nav class="header__menu">
      <a class="header__logo" href="/content/index.html">
        <img 
      ...
      <ul class="menu-list">
        <li class="menu-list-item">
          <a class="menu-list-item-link" href="/content/index.html">Главная</a>
        </li>
        <li class="menu-list-item">
          <a class="menu-list-item-link" href="/content/index.html#part_catalog">Магазин</a>
        </li>
        <li class="menu-list-item">
